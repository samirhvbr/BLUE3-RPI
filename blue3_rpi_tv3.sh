...
echo "/usr/bin/chromium-browser --noerrdialogs --disable-infobars --kiosk \"https://prtg.blue3.cloud/public/mapshow.htm?id=2922&mapid=A9F6E667-48E9-42C9-A6E5-FCB6C53199AC\" &" >> $FILE
echo "" >> $FILE
