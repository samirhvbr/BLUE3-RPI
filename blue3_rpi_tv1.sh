...
echo "/usr/bin/chromium-browser --noerrdialogs --disable-infobars --kiosk \"https://prtg.blue3.cloud/public/mapshow.htm?id=2920&mapid=AB33E8E1-37AA-4BA1-A308-7F47F7B539A3\" &" >> $FILE
echo "" >> $FILE
