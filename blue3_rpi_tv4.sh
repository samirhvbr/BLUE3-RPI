...
echo "/usr/bin/chromium-browser --noerrdialogs --disable-infobars --kiosk \"https://prtg.blue3.cloud/public/mapshow.htm?id=2921&mapid=0ACA64AC-A097-43FE-AB9D-FA4793BE5760\" &" >> $FILE
echo "" >> $FILE
